...
public String toString() {
	return "Notice [notice_id=" + notice_id + ", receive_id=" + receive_id + ", subject=" + subject + ", text=" + text
			+ ", pub_time=" + pub_time + ", expire_time=" + expire_time + ", status=" + status + ", remark=" + remark
			+ ", create_time=" + create_time + ", creater=" + creater + ", update_time=" + update_time + ", updater="
			+ updater + "]";
}
