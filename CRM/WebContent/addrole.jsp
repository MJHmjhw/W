...
<form action="role" onsubmit="return a()">
    ...
    <tr>
      ...
      <td colspan="6">
          <input type="text" name="role_name" value="" id="name"><i id="i"></i>
      </td>
    </tr>
    <tr>
      <td colspan="2" rowspan="6" style="line-height:200px;" >角色描述</td>
      <td colspan="6" rowspan="6">
          <textarea name="remark" id="" cols="80" rows="10" style="outline:none;resize:none;border:none;" placeholder="请输入角色描述"></textarea>
      </td>
    </tr>
</table>

<div id="btn">   
<input type="hidden" name="r" value="addrole"> 
