...
<form action="msg">
	<table>
		<tr>
			<td>收件人</td>
			<td><input type="text" name="receiver" value="${message.receiver}"/></td>
		</tr>
		<tr>
			<td>主题</td>
		...
		<tr>
			<td>内容</td>
			<td><textarea name="content" rows="20" cols="120">${message.content}</textarea></td>
		</tr>
	</table>
	<input type="hidden" name="message_id" value ="${message.message_id}"/>
	<input type="hidden" name="ms" value = "updateById"/>
