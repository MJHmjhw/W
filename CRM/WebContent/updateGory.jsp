...
<form action="gory" onsubmit="return a()">
 ...
 <p>添加分类</p>
	...
	<tr>
						<td id="c1">分类名称</td>
						<td id="c3"><input type="text" name="customer_category_name" style="border:1px solid #ADADAD" id="name"value="${a.customer_category_name}"/><i id="i"></i></td>
					</tr>
					<tr style="height: 300px;">
					<td id="c2">分类描述</td>
					<td><textarea id="c4" name="customer_category_desc" cols="120" rows="10" style="outline:none;resize:none;border:none;">
						${a.customer_category_desc}
					</textarea></td>
					</tr>
</table>
<div id="btn">  
<input type="hidden" name="g" value="addGory"/>
<input type="hidden" name="customer_category_id" value="${category.customer_category_id}"/>
...
<div id="fanhui"><a href="gory?g=allGory" class="btn btn-default">返回</a></div>
	...
	var flag=true;
	$("#name").blur(function(){
		if($("#name").val()=='${a.customer_category_name}'){
			$("#i").text("");
		}else{
		$.get({
			url:"gory?g=check",
