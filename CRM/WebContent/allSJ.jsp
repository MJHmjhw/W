...
<body>
	<div id="zong">
		...
		<div>
			...
			<form action="msg">
				<input type="text" name="recname" value="${str}">
				<!-- 		<span>搜索字段：</span> -->
				<!--         <select name="find" id=""> -->
				<!--                     <option>用户名</option> -->
				<!--                     <option>id</option> -->
				<!--         </select> -->
				<input type="hidden" name="ms" value="selectFJ"> <input
		...
		<table>
			...
			<c:forEach items="${list}" var="msg">
				<tr>
					...
					<td><a href="msg?n=delete&id=${msg.message_id}"><i class="fa fa-times"></i></td>
				</tr>
			</c:forEach>
		...
		<div id="pa">
			...
			<ul class="pagination">
				...
				<li><c:if test="${page2>1&&page2<=page}">
						<a href="msg?ms=allSJ&page=${page2-1}">上一页</a>
					</c:if></li>
				<li class="active"><a>${page2}</a></li>

				<li><c:if test="${page2>=1&&page2<page-1}">
						<a href="msg?ms=allSJ&page=${page2+1}">下一页</a>
					</c:if></li>
