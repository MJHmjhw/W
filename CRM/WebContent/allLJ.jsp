...
<body>
	<div id="zong">
		...
		<div>
			...
			<form action="msg">
				<input type="text" name="receicename" value="${str}">
				<!-- 		<span>搜索字段：</span> -->
				<!--         <select name="find" id=""> -->
				<!--                     <option>用户名</option> -->
				<!--                     <option>id</option> -->
				<!--         </select> -->
				<input type="hidden" name="n" value="findsend"> <input
		...
		<table>
			...
			<c:forEach items="${list}" var="msg">
				<tr>
					...
					<td>
					<a href="msg?ms=deleteSJ&message_id=${msg.message_id}"><i class="fa fa-times"></i></a></td>
				</tr>
			</c:forEach>
		</table>
